...
# -*- coding: utf-8 -*-
"""
Created on Fri May 12 17:06:57 2023
...
raw_data = scipy.io.loadmat('twonorm.mat')

##Training data (e.g, wbcd dataset)
# ===========================================
#  Wisconsin breast cancer data
#  source: https://www.kaggle.com/uciml/breast-cancer-wisconsin-data
data = raw_data['full_set']
...
beta=1.95 # inverse temperature
epsilon=1  #entropic regularizing coefficient
h=1e-4 # time step
numSteps=int(1e4+1) #1e6 # number of steps k, in discretization t=kh
